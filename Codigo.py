...
def evaluar_riesgo():
    ...
    # Enviar SMS si el riesgo es alto
    if riesgo_embarazo == 1:
        numero_telefono = input("Ingrese el número de teléfono para el SMS: ")
        mensaje = f"Riesgo de preeclampsia: {riesgo_embarazo}\n{consejo}\n¡Consulta a tu médico!"
        enviar_sms(numero_telefono, mensaje)
